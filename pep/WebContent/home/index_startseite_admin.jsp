        ...
        <div class="d-flex align-items-stretch">
            ...
            <div class="page-holder w-100 d-flex flex-wrap">
                <div class="container-fluid px-xl-5">
                    ...
                    <h5>Hallo Max Mustermann,</h5> 
                    Das Planungs und Entwicklunsprojekt beefindet sich momentan in folgender Phase: Projekterarbeitungsphase<!-- Hier aktuelle Phase anzeigen -->
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom">
                        <h3 class="h3"><b>Aufgaben des Administrators:</b></h3>
                    </div>
                    <div class="pt-2 pb-2">
                        <h5>1. Projekt Setup Phase:</h5>
                        <p>Der Administrator hat noch vor beginn des Projekts die Aufgabe, die Projekt-Einstellungen vorzunehmen (Linke Sidebar unter <strong>"Project Settings"</strong>).</p>
                        - Legen Sie unter <strong>"Allgemein"</strong> die minimale und maximale Teilnehmerzahl fest</br>
                        - Legen Sie unter <strong>"Phasen"</strong> die Fristen der Phasen fest</br>
                        - Legen Sie unter <strong>"Masterkeys"</strong> die Passwörter fest, die für die Erstellung der Juroren und Betreuer Accounts erforderlich sind</br>
                        - Legen Sie unter <strong>"Listen"</strong> Lehrstühle und Studiengänge an. Aus diesen können die Studenten und Betreuern später bei der Registrierung in einem Dropdown Feld wählen</br>
                        - Legen Sie unter <strong>"Startbildschirme"</strong> die "Home" Screens fest, die den Studenten, Betreuern und Juroren später auf der Startseite angezeigt werden. Nutzen Sie diese Funktion um Informationen, wie etwa Termine, bekannt zu geben</br>  
                    </div>
                    <div class="pt-2 pb-2">
                        <h5>2. Registrierungs Phase:</h5>
                        <p>Während der Regestrierungsphase gibt es für den Administrator nichts zu tun.</p>
                        -Falls es bei der Registrierung bei Teilnehmern schwierigkeiten geben sollte, können Sie unter <strong>"Accounts"</strong> kaputte Accounts löschen oder Änderungen vornehmen 
                    </div>
                    <div class="pt-2 pb-2">
                        <h5>3. Projekt Anmelde Phase</h5>
                        <p>Während der Projekt Anmelde Phase erstellen Sie die Teams und weisen ihnen die Accounts zu. Beachten Sie, dass Sie dadurch das Projekt des Teams bestätigen.</p>
                        - Warten Sie bis der von den Teammitgliedern bestimmte Teamleiter sich bei Ihnen mit den Teamdetails meldet </br>
                        - Erstellen Sie unter <strong>"Teams"</strong> Teams mit den von den Teamleitern stammenden Teamdetails</br>
                        - Weisen Sie den Teamvorsitzenden unter <strong>"Accounts"</strong> die Rolle "Teamvorsitzender" zu</br>
                    </div>
                    <div class="pt-2 pb-2">
                        <h5>4. Projekt Erarbeitungs Phase</h5>
                        <p>Während der Projekterarbeitungsphase haben Sie so gut wie nichts zutun bis auf</p>
                        - Spätestens zum Ende sollten Sie unter <strong>"Project Settings" -> "Listen"</strong> die Bewertungskriterien festgelegt haben</br>
                    </div>
                    <div class="pt-2 pb-2">
                        <h5>5. Projekt Bewertungs Phase</h5>
                        - Zu beginn der Projekt Bewertungs Phase sollten Sie manuell über den Button auf Ihrer Startseite die Bewertung durch die Juroren freischalten</br>
                        - Sie können die Bewertungen der Juroren unter <strong>"Teams"</strong> anschauen und gegebenenfalls anpassen</br>
                        - Sobald die Bewertungen abgeschlossen sind können Sie über Ihre Startseite eine PDF Datei mit einer Liste der jeweils besten Teams und eine PDF Datei mit einer Abschlusspräsentation herunterladen</br>
                    </div>
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom">
